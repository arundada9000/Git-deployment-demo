  ...
  return (
    ...
    >
      <div className="absolute top-[70px]">
        <SplitText
          text="How to Push your code to github and deploy it to vercel | Code with ease"
      ...
      >
        ...
        >
          <div
            ...
            aria-label="Logo"
            onClick={() =>
              (window.location.href = "https://www.youtube.com/@code_with_ease")
            }
            role="link"
            tabIndex={0}
            onKeyDown={(e) => {
              if (e.key === "Enter" || e.key === " ") {
                window.location.href =
                  "https://www.youtube.com/@code_with_ease";
              }
            }}
          >
            <img
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; pointer-events: none; z-index: 100; }
